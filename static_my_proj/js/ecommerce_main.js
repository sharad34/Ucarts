...
var stripeTemplate = $.templates("#stripeTemplate")//getting the template
//now to pass context
...
//     } else {
//     	console.log("hehhhhhhhhhhhhhhhhhh")
//     	//console.log(nextUrl)
//     	console.log(nextUrl)
...
// Handle form submission converted to jQuery.
...
function displayBtnStatus(element, newHtml, newClasses, loadTime, timeout){//gives functionality for the button status
	  // if (timeout){
...
function stripeTokenHandler(nextUrl, token)
{
	...
	$.ajax({
		...
		error: function(error){
			console.log(error)
			$.alert({title:"an error occured", content:"Please try adding your cart again"})
			btnLoad.html(btnLoadDefaultHtml)
		    btnLoad.attr('class', btnLoadDefaultClasses)
